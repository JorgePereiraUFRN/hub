...
public class HubResource {
   ...
   /* metodo usado para publicar atualiza��es, para isto p publish deve passar o
    identificador do topico e a atualiza��o que ser� enviada para os
    subscriber
    */
   ...
   /* m�todo usado para registrar um t�pico no hub, para isto o publish deve 
    enviar o identificador do topico. Caso o topico n�o exista ele ser�cadadtrado
    e retornara a string sucess, caso o topico ja esteja cadastrado ele retornar�
   ...
   /* metodo usado pelo subscriber para registrar interesse em receber atualiza��es 
    acerca de um topico, para isso ele deve enviar um objeto do tipo subscriberbean
    que contem seu endere�o ip, a porta na quala aguardara pelas atualiza��es
    ...
    /*
    metodo usado pelo subscribe para cancelar o interesse em receber atualiza��es a cerca 
    de um t�pico, para isso ele deve enviar um objeto do tipo subscriberbean
    que contem seu endere�o ip, a porta na quala aguardar pelas atualiza��es
    e o topico de interesse*/
